        ...
        if move < ans:
            for i in range(4):
                ...
                if 0 <= n_row < H and 0 <= n_col < W:
                    if area[n_row][n_col] != 1 and not visited[n_row][n_col][K - remain]:
                        visited[n_row][n_col][K - remain] = True
                    ...
                    if remain > 0:
                        for j in range(2):
                            ...
                            if 0 <= h_row < H and 0 <= h_col < W and area[h_row][h_col] != 1:
                                if not visited[h_row][h_col][K - (remain-1)]:
                                    visited[h_row][h_col][K - (remain-1)] = True
